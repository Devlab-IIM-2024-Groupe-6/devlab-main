...
final class Version20250110152617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device_maintenance (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, deposit_id INT NOT NULL, screen TINYINT(1) DEFAULT NULL, oxidation_status TINYINT(1) DEFAULT NULL, hinges TINYINT(1) DEFAULT NULL, fan TINYINT(1) DEFAULT NULL, button TINYINT(1) DEFAULT NULL, sensors TINYINT(1) DEFAULT NULL, chassis TINYINT(1) DEFAULT NULL, data_wipe TINYINT(1) DEFAULT NULL, computer_unlock TINYINT(1) DEFAULT NULL, driver TINYINT(1) DEFAULT NULL, computer_update TINYINT(1) DEFAULT NULL, motherboard TINYINT(1) DEFAULT NULL, networks TINYINT(1) DEFAULT NULL, components TINYINT(1) DEFAULT NULL, battery TINYINT(1) DEFAULT NULL, power_supply TINYINT(1) DEFAULT NULL, tracking_number VARCHAR(255) DEFAULT NULL, INDEX IDX_5D04AC2F19EB6921 (client_id), INDEX IDX_5D04AC2F9815E4B1 (deposit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
